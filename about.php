    ...
    <div class="background">
            ...
            <div class="content">
                <div class="main-top">
                    ...
                    can help the students and teachers studying the subject and also it will give them great experience while learning. </p>
                </div>
                    <div class="main-content">
                        <h2>Who we are?</h2>
                        <p>The developers are Bachelor of Science in Information Technology students from 
                            ...
                            <div class="dev-info">
                                <img src="assets/img/" width="125" height="125">
                                <p class="name">Desales, Mary Joy  <br>Front-End Developer</p>
                                <!-- <p class="role">Role</p> -->
                            </div>
                            ...
                            <div class="dev-info">
                                <img src="assets/img/" width="125" height="125">
                                <p class="name">Francisco, Veronica  <br>Project Leader</p>
                                <!-- <p class="role">Role</p> -->
                            </div>
