...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['location'])) {
    ...
    $adminExPaths = array("index.php", "register.php", "student-list.php", "add-teacher.php", "user-list.php", "archive.php", "section.php", "account.php", "archive-teacher.php", "archive-admin.php");
